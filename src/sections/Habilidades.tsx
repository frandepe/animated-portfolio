    ...
    let tl = gsap
      .timeline({
        scrollTrigger: {
          ...
          // scrub va y vuelve el efecto uando scrolea
          scrub: true,
        },
      })
    ...
    <Section>
      ...
      {/* <TextBlockRight>
        ...
        <Text>
          ...
          aperiam optio excepturi labore minima s
        </Text>
      </TextBlockRight> */}
      ...
      <TextContainer>
        <MovingText ref={textOne}>lorem ipsum</MovingText>
        <MovingText ref={textTwo}>otro texto aca</MovingText>
      </TextContainer>
    </Section>
  );
};
